...
func (t *BlockTest) InsertPreState(db krdb.Database, am *accounts.Manager) (*state.StateDB, error) {
...
/* See https://github.com/krypton/tests/wiki/Blockchain-Tests-II

   Whkrypton a block is valid or not is a bit subtle, it's defined by presence of
