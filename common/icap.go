...
// Spec at https://github.com/krypton/wiki/wiki/ICAP:-Inter-exchange-Client-Address-Protocol
...
func parseICAP(s string) (Address, error) {
	...
	// checksum is ISO13616, Krypton address is base-36
...
func clientIdentToIndirectICAP(instCode, clientIdent string) (string, error) {
	...
	// currently KR is only valid asset identifier
	s := join("KR", instCode, clientIdent)
