...
/* More test vectors:
https://github.com/krypton/web3.js/blob/master/test/iban.fromAddress.js
https://github.com/krypton/web3.js/blob/master/test/iban.toAddress.js
https://github.com/krypton/web3.js/blob/master/test/iban.isValid.js
https://github.com/krypton/libkrypton/blob/develop/test/libkrcore/icap.cpp
*/
...
var icapInvalidTests = []icapTest{
	...
	{"IndirectInvalidCheckSum", "", "XE35KRXREGGOPHERSSS"},
	{"IndirectInvalidAssetIdentifier", "", "XE34KRXREGGOPHERSSS"},
	{"IndirectInvalidLength19", "", "XE34KRXREGGOPHERSS"},
	{"IndirectInvalidLength21", "", "XE34KRXREGGOPHERSSSS"},
}
