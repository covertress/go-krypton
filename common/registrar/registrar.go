...
/*
Registrar implements the Krypton name registrar services mapping
- arbitrary strings to krypton addresses
- hashes to hashes
...
// Registrar's backend is defined as an interface (implemented by xkr, but could be remote)
