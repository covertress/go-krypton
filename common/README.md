...
[![Build
Status](https://travis-ci.org/krypton/go-krypton.png?branch=master)](https://travis-ci.org/krypton/go-krypton)

The common package contains the krypton utility library.

# Installation

As a subdirectory the main go-krypton repository, you get it with
`go get github.com/krypton/go-krypton`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the Krypton project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.krypton.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the Krypton project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.krypton.org/index.php/Patricia_Tree).
