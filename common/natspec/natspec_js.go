 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of KR_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.KR_PADDING * 2;
    return 0;
};
...
/** @file formatters.js
 * @authors:
 *   Marek Kotewicz <marek@krdev.com>
 * @date 2015
 */
...
var formatInputInt = function (value) {
    var padding = c.KR_PADDING * 2;
    BigNumber.config(c.KR_BIGNUMBER_ROUNDING_MODE);
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.KR_PADDING).substr(2);
};
...
/// required to define KR_BIGNUMBER_ROUNDING_MODE
var BigNumber = require('bignumber.js');
...
module.exports = {
    KR_PADDING: 32,
    KR_SIGNATURE_LENGTH: 4,
    KR_UNITS: KR_UNITS,
    KR_BIGNUMBER_ROUNDING_MODE: { ROUNDING_MODE: BigNumber.ROUND_DOWN },
    KR_POLLING_TIMEOUT: 1000,
    KR_DEFAULTBLOCK: 'latest'
};
...
var unitMap = {
    ...
    'kr':    '1000000000000000000',
    'kkr':   '1000000000000000000000',
    'grand':    '1000000000000000000000',
    'einstein': '1000000000000000000000',
    'mkr':   '1000000000000000000000000',
    'gkr':   '1000000000000000000000000000',
    'tkr':   '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default kr
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'kr';
...
/**
 * Takes a number of wei and converts it to any other kr unit.
 *
 * Possible units are:
 * - kwei/ada
 * - mwei/babbage
 ...
 * @param {String} unit the unit to convert from, default kr
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
    ...
    */
    ...
    function another(configObj) {
        var div,
            ...
            // Whkr BigNumber Errors are ever thrown.
            ERRORS = true,                           // true or false

            // Change to intValidatorNoErrors if ERRORS is false.
            isValidInt = intValidatorWithErrors,     // intValidatorWithErrors/intValidatorNoErrors

            // Whkr to use cryptographically-secure random number generation, if available.
                ...
                out: {
                    ...
                    r = rm < 4
                      ...
                      : rd > 5 || rd == 5 && ( rm == 4 || r || rm == 6 &&
                        ...
                        // Check whkr the digit to the left of the rounding digit is odd.
         ...
         *
         * [z] {boolean|number} Whkr to count integer-part trailing zeros: true, false, 1 or 0.
         */
