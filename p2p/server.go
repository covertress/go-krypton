...
// Package p2p implements the Krypton p2p network protocols.
package p2p
...
type Server struct {
	...
	// Discovery specifies whkrypton the peer discovery mechanism should be started
...
func (srv *Server) startListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "krypton p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
