...
// genTxRing returns a block generator that sends krypton in a ring
...
func benchInsertChain(b *testing.B, disk bool, gen func(int, *BlockGen)) {
	...
	var db krdb.Database
	if !disk {
		db, _ = krdb.NewMemDatabase()
	} else {
		dir, err := ioutil.TempDir("", "kr-core-bench")
		if err != nil {
			b.Fatalf("cannot create temporary directory: %v", err)
		}
		defer os.RemoveAll(dir)
		db, err = krdb.NewLDBDatabase(dir, 0)
		if err != nil {
