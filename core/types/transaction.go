...
// signature.
//
// From Uses the homestead consensus rules to determine whkr the signature is
// valid.
//
...
// incorrect signature.
//
// FromFrantier uses the frontier consensus rules to determine whkr the
// signature is valid.
//
...
// satisfied, the results are merged back togkr by price, always comparing only
