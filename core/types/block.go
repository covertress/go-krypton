...
// Package types contains data types related to Krypton consensus.
package types
...
// a block's data contents (transactions and uncles) togkrypton.
type Body struct {
...
type Block struct {
	...
	// ReceivedAt is used by package kr to track block propagation time.
...
// "external" block encoding. used for kr protocol, etc.
