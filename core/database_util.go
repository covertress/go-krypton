...
import (
	...
	"github.com/krypton/go-krypton/params"
...
func GetCanonicalHash(db krdb.Database, number uint64) common.Hash {
...
func GetHeadHeaderHash(db krdb.Database) common.Hash {
...
func GetHeadBlockHash(db krdb.Database) common.Hash {
...
func GetHeadFastBlockHash(db krdb.Database) common.Hash {
...
func GetHeaderRLP(db krdb.Database, hash common.Hash) rlp.RawValue {
...
// found.
func GetHeader(db krdb.Database, hash common.Hash) *types.Header {
...
func GetBodyRLP(db krdb.Database, hash common.Hash) rlp.RawValue {
...
func GetBody(db krdb.Database, hash common.Hash) *types.Body {
...
// none found.
func GetTd(db krdb.Database, hash common.Hash) *big.Int {
...
func GetBlock(db krdb.Database, hash common.Hash) *types.Block {
...
func GetBlockReceipts(db krdb.Database, hash common.Hash) types.Receipts {
...
func GetTransaction(db krdb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db krdb.Database, txHash common.Hash) *types.Receipt {
...
func WriteCanonicalHash(db krdb.Database, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db krdb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db krdb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db krdb.Database, hash common.Hash) error {
...
func WriteHeader(db krdb.Database, header *types.Header) error {
...
func WriteBody(db krdb.Database, hash common.Hash, body *types.Body) error {
...
func WriteTd(db krdb.Database, hash common.Hash, td *big.Int) error {
...
func WriteBlock(db krdb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db krdb.Database, hash common.Hash, receipts types.Receipts) error {
...
func WriteTransactions(db krdb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipts(db krdb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteReceipt(db krdb.Database, hash common.Hash) {
...
// network transitions to kr/63.
func GetBlockByHashOld(db krdb.Database, hash common.Hash) *types.Block {
...
// MIP bloom bin.
func WriteMipmapBloom(db krdb.Database, number uint64, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func GetMipmapBloom(db krdb.Database, number, level uint64) types.Bloom {
