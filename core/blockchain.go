...
// Package core implements the Krypton consensus protocol.
package core
...
// available in the database. It initialiser the default Krypton Validator and
// Processor.
func NewBlockChain(chainDb krdb.Database, pow pow.PoW, mux *event.TypeMux) (*BlockChain, error) {
	...
	if bc.genesisBlock == nil {
		...
		glog.V(logger.Info).Infoln("WARNING: Wrote default krypton genesis block")
	}
...
//
// The verify parameter can be used to fine tune whkrypton nonce verification
