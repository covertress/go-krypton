...
func WriteGenesisBlock(chainDb krdb.Database, reader io.Reader) (*types.Block, error) {
...
func GenesisBlockForTesting(db krdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func WriteGenesisBlockForTesting(db krdb.Database, accounts ...GenesisAccount) *types.Block {
	accountJson := "{"
...
func WriteTestNetGenesisBlock(chainDb krdb.Database, nonce uint64) (*types.Block, error) {
	testGenesis := fmt.Sprintf(`{
        "nonce": "0x%x",
        "difficulty": "0x20000",
...
func WriteOlympicGenesisBlock(chainDb krdb.Database, nonce uint64) (*types.Block, error) {
	testGenesis := fmt.Sprintf(`{
	"nonce":"0x%x",
	"gasLimit":"0x%x",
	"difficulty":"0x%x",
