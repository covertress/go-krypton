...
func makeTestState() (krdb.Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db krdb.Database, root common.Hash, accounts []*testAccount) {
	state, _ := New(root, db)
