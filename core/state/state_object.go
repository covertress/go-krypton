...
func NewStateObject(address common.Address, db krdb.Database) *StateObject {
...
func NewStateObjectFromBytes(address common.Address, data []byte, db krdb.Database) *StateObject {
