...
/*  DO NOT EDIT!!!
    ...
    https://github.com/krypton/cpp-krypton/blob/develop/libkrash-cl/krash_cl_miner_kernel.cl
	...
	)
{
	...
	// Threads work togkrypton in this phase in groups of 8.
...
__kernel void krash_hash_simple(
...
__attribute__((reqd_work_group_size(GROUP_SIZE, 1, 1)))
__kernel void krash_search_simple(
...
__attribute__((reqd_work_group_size(GROUP_SIZE, 1, 1)))
__kernel void krash_hash_chunks(
	__global hash32_t* g_hashes,
	__constant hash32_t const* g_header,
	__global hash128_t const* g_dag,
	__global hash128_t const* g_dag1,
...
__attribute__((reqd_work_group_size(GROUP_SIZE, 1, 1)))
__kernel void krash_search_chunks(
	__global volatile uint* restrict g_output,
	__constant hash32_t const* g_header,
	__global hash128_t const* g_dag,
	__global hash128_t const* g_dag1,
