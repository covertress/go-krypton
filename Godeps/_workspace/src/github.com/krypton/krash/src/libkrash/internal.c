...
)
{
	...
	// pack hash and nonce togkrypton into first 40 bytes of s_mix
...
)
{
	...
	case ETHASH_IO_FAIL:
		// krash_io_prepare will do all ETHASH_CRITICAL() logging in fail case
		goto fail_free_full;
	...
	case ETHASH_IO_MEMO_SIZE_MISMATCH:
		...
		if (krash_io_prepare(dirname, seed_hash, &f, (size_t)full_size, true) != ETHASH_IO_MEMO_MISMATCH) {
