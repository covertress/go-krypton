...
#define KRASH_REVISION 23
#define KRASH_DATASET_BYTES_INIT 1073741824U // 2**30
#define KRASH_DATASET_BYTES_GROWTH 8388608U  // 2**23
#define KRASH_CACHE_BYTES_INIT 1073741824U // 2**24
#define KRASH_CACHE_BYTES_GROWTH 131072U  // 2**17
#define KRASH_EPOCH_LENGTH 30000U
#define KRASH_MIX_BYTES 128
#define KRASH_HASH_BYTES 64
#define KRASH_DATASET_PARENTS 256
#define KRASH_CACHE_ROUNDS 3
#define KRASH_ACCESSES 64
#define KRASH_DAG_MAGIC_NUM_SIZE 8
#define KRASH_DAG_MAGIC_NUM 0xFEE1DEADBADDCAFE
