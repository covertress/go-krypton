...
// init params
var krashParams = krash.defaultParams();
//krashParams.cacheRounds = 0;

// create hasher
var seed = util.hexStringToBytes("9410b944535a83d9adf6bbdcc80e051f30676173c16ca0d32d6f1263fc246466")
var startTime = new Date().getTime();
var hasher = new krash.Krash(krashParams, seed);
console.log('Krash startup took: '+(new Date().getTime() - startTime) + "ms");
console.log('Krash cache hash: ' + util.bytesToHexString(hasher.cacheDigest()));
