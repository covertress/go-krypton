...
type Options struct {
	...
	// ErrorIfExist defines whkr an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whkr an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whkr block reads for this 'read operation'
...
type WriteOptions struct {
	// Sync is whkr to sync underlying writes from the OS buffer cache
