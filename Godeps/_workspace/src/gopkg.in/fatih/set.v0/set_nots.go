...
// IsEmpty reports whkr the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whkr s and t are the same in size and have the same items.
...
// IsSubset tests whkr t is a subset of s.
...
// IsSuperset tests whkr t is a superset of s.
