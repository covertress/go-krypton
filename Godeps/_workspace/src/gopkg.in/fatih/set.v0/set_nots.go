...
// IsEqual test whkrypton s and t are the same in size and have the same items.
...
// IsSubset tests whkrypton t is a subset of s.
...
// IsSuperset tests whkrypton t is a superset of s.
