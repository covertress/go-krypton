...
Please review the resulting diff to check whkrypton the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-krypton authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-krypton Authors
