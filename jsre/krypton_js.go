...
/**
 * This method should be used to combine solidity params togkr
...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/krypton/web3.js/pull/205');
...
var unitMap = {
    ...
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'microkr':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'millikr':    '1000000000000000',
 ...
 * - kwei       femtokr     ada
 * - mwei       picokr      babbage
 * - gwei       nanokr      shannon      nano
 * - --         microkr     szabo        micro
 * - --         millikr     finney       milli
 * - kr      --             --
 * - kkr                    einstein     grand
 * - mkr
 * - gkr
...
/** @file web3.js
 * @authors:
 *   Jeffrey Wilcke <jeff@krdev.com>
 *   Marek Kotewicz <marek@krdev.com>
 *   Marian Oancea <marian@krdev.com>
 *   Fabian Vogelsteller <fabian@krdev.com>
 *   Gav Wood <g@krdev.com>
 * @date 2014
 */

var version = require('./version.json');
var net = require('./web3/methods/net');
var kr = require('./web3/methods/kr');
...
web3.kr.isSyncing = function (callback) {
    return new IsSyncing(callback);
};

/*jshint maxparams:4 */
web3.kr.filter = function (fil, callback) {
    return new Filter(fil, watches.kr(), formatters.outputLogFormatter, callback);
};
/*jshint maxparams:3 */
...
// ADD defaultblock
Object.defineProperty(web3.kr, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(web3.kr, 'defaultAccount', {
    get: function () {
...
setupMethods(web3.kr, kr.methods);
setupProperties(web3.kr, kr.properties);
...
AllSolidityEvents.prototype.execute = function (options, callback) {
    ...
    return new Filter(o, watches.kr(), formatter, callback);
};
...
var checkForContractAddress = function(contract, abi, callback){
    ...
    // wait for receipt
    var filter = web3.kr.filter('latest', function(e){
        if(!e && !callbackFired) {
            count++;
            ...
            if(count > 50) {
                ...
                web3.kr.getTransactionReceipt(contract.transactionHash, function(e, receipt){
                    if(receipt && !callbackFired) {

                        web3.kr.getCode(receipt.contractAddress, function(e, code){
                            /*jshint maxcomplexity: 5 */
...
ContractFactory.prototype.new = function () {
    ...
    if(callback) {
        ...
        web3.kr.sendTransaction(options, function (err, hash) {
            if (err) {
                callback(err);
            } else {
        ...
        var hash = web3.kr.sendTransaction(options);
        // add the transaction hash
        contract.transactionHash = hash;
 ...
 * @return {Object} everything combined togkr and encoded
 */
 ...
 * @file formatters.js
 * @author Marek Kotewicz <marek@krdev.com>
 * @author Fabian Vogelsteller <fabian@krdev.com>
 * @date 2015
 */
...
SolidityFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = web3.kr.call(payload, defaultBlock);
        return this.unpackOutput(output);
    }

    var self = this;
    web3.kr.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return web3.kr.sendTransaction(payload);
    }

    web3.kr.sendTransaction(payload, callback);
};
...
SolidityFunction.prototype.estimateGas = function () {
    ...
    if (!callback) {
        return web3.kr.estimateGas(payload);
    }

    web3.kr.estimateGas(payload, callback);
};
...
var HttpProvider = function (host) {
    this.host = host || 'http://localhost:8888';
};
...
/**
 * This method should be used to create iban object from krypton address
 *
 * @method fromAddress
 * @param {String} address
...
Iban.createIndirect = function (options) {
    return Iban.fromBban('KR' + options.institution + options.identifier);
};
...
Iban.prototype.isValid = function () {
    return /^XE[0-9]{2}(KR[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) &&
...
/// @returns an array of objects describing web3.kr api methods
...
/// @returns an array of objects describing web3.kr api properties
...
/// @returns an array of objects describing web3.kr.filter api methods
var kr = function () {
 ...
 * @author Jeffrey Wilcke <jeff@krdev.com>
 * @author Marek Kotewicz <marek@krdev.com>
 * @author Marian Oancea <marian@krdev.com>
 * @author Fabian Vogelsteller <fabian@krdev.com>
 ...
 * It's also responsible for polling the krypton node for incoming messages
...
RequestManager.prototype.poll = function () {
    /*jshint maxcomplexity: 6 */
    this.timeout = setTimeout(this.poll.bind(this), c.KR_POLLING_TIMEOUT);
...
var transferToAddress = function (from, to, value, callback) {
    return web3.kr.sendTransaction({
        address: to,
        from: from,
        value: value
    }, callback);
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	    ...
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whkr all blocks and partial blocks should be processed.
	         *
...
web3.kr.contract = require('./lib/web3/contract');
web3.kr.namereg = namereg.namereg;
web3.kr.ibanNamereg = namereg.ibanNamereg;
web3.kr.sendIBANTransaction = require('./lib/web3/transfer');
web3.kr.iban = require('./lib/web3/iban');
