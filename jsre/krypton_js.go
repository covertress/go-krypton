...
/**
 * This method should be used to combine solidity params togkrypton
...
var unitMap = {
    ...
    'gwei':         '1000000000',
    'shannon':      '1000000000',
    'nanokrypton':    '1000000000',
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'microkrypton':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'millikrypton':    '1000000000000000',
    'milli':         '1000000000000000',
    'krypton':        '1000000000000000000',
    'kkrypton':       '1000000000000000000000',
    'grand':        '1000000000000000000000',
    'einstein':     '1000000000000000000000',
    'mkrypton':       '1000000000000000000000000',
    'gkrypton':       '1000000000000000000000000000',
    'tkrypton':       '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default krypton
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'krypton';
...
/**
 * Takes a number of wei and converts it to any other krypton unit.
 *
 * Possible units are:
 *   SI Short   SI Full        Effigy       Other
 * - kwei       femtokrypton     ada
 * - mwei       picokrypton      babbage
 * - gwei       nanokrypton      shannon      nano
 * - --         microkrypton     szabo        micro
 * - --         millikrypton     finney       milli
 * - krypton      --             --
 * - kkrypton                    einstein     grand
 * - mkrypton
 * - gkrypton
 * - tkrypton
 *
 ...
 * @param {String} unit the unit to convert from, default krypton
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
 ...
 * @return {Object} everything combined togkrypton and encoded
 */
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	    ...
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whkrypton all blocks and partial blocks should be processed.
	         *
