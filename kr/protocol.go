...
// Supported versions of the kr protocol (first is primary).
var ProtocolVersions = []uint{kr63, kr62, kr61}
...
// kr protocol message codes
const (
	// Protocol messages belonging to kr/61
	StatusMsg                   = 0x00
	...
	// Protocol messages belonging to kr/62 (new protocol from scratch)
	// StatusMsg          = 0x00 (uncomment after kr/61 deprecation)
	// NewBlockHashesMsg  = 0x01 (uncomment after kr/61 deprecation)
	// TxMsg              = 0x02 (uncomment after kr/61 deprecation)
	GetBlockHeadersMsg = 0x03
	BlockHeadersMsg    = 0x04
	GetBlockBodiesMsg  = 0x05
	BlockBodiesMsg     = 0x06
	// 	NewBlockMsg       = 0x07 (uncomment after kr/61 deprecation)

	// Protocol messages belonging to kr/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
