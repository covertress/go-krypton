...
// package filters implements an krypton filtering system for block,
...
// for specific LOG events fired by the EVM (Krypton Virtual Machine).
...
// filterLoop waits for specific events from krypton and fires their handlers
