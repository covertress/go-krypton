...
import (
	...
	"github.com/krypton/go-krypton/jsre"
...
type Jkr struct {
	krApi shared.KryptonApi
	re     *jsre.JSRE
	client comms.KryptonClient
	fe     xkr.Frontend
}

func NewJkr(krApi shared.KryptonApi, re *jsre.JSRE, client comms.KryptonClient, fe xkr.Frontend) *Jkr {
	return &Jkr{krApi, re, client, fe}
}

func (self *Jkr) err(call otto.FunctionCall, code int, msg string, id interface{}) (response otto.Value) {
...
func (self *Jkr) Send(call otto.FunctionCall) (response otto.Value) {
...
// the user response back to the gkr service
func (self *Jkr) handleRequest(req *shared.Request) bool {
	var err error
	var args []interface{}
...
func (self *Jkr) askPassword(id interface{}, jsonrpc string, args []interface{}) bool {
	var err error
	var passwd string
	if len(args) >= 1 {
...
func (self *Jkr) confirmTransaction(id interface{}, jsonrpc string, args []interface{}) bool {
