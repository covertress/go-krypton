...
/** Verify whkr a field element represents zero i.e. would normalize to a zero value. The field
...
/** Verify whkr a field element is zero. Requires the input to be normalized. */
 ...
 *  normalized). Return value indicates whkr a square root was found. */
