...
/** Verify whkrypton a field element represents zero i.e. would normalize to a zero value. The field
...
/** Verify whkrypton a field element is zero. Requires the input to be normalized. */
 ...
 *  normalized). Return value indicates whkrypton a square root was found. */
